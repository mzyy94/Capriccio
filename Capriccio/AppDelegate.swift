...
class AppDelegate: UIResponder, UIApplicationDelegate {
	...
	func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
		...
		UITabBar.appearance().tintColor = UIColor.paperColorTeal200()
		...
		UIButton.appearanceWhenContainedInInstancesOfClasses([ProgramTableViewController.self]).setTitleColor(UIColor.paperColorRed500(), forState: .Normal) // for UITableViewRowAction
	...
	lazy var applicationDocumentsDirectory: NSURL = {
		// The directory the application uses to store the Core Data store file. This code uses a directory named "com.mzyy94.Capriccio" in the application's documents Application Support directory.
	...
	lazy var managedObjectModel: NSManagedObjectModel = {
		...
		let modelURL = NSBundle.mainBundle().URLForResource("Capriccio", withExtension: "momd")!
	...
	lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator? = {
		...
		let url = self.applicationDocumentsDirectory.URLByAppendingPathComponent("Capriccio.sqlite")
